...
$string['logout_cas'] = "<p>Sie wurden aus dem Lernportal Informatik abgemeldet.</p>
<p>Sie sind immer noch im zentralen Authentifizierungsdienst (SSO) der TU Darmstadt angemeldet. Sie können sich aus dem SSO-Verbund abmelden oder zur Startseite zurückkehren.</p>";
$string['button_logout_cas'] = "Aus dem SSO-Verbund abmelden";
