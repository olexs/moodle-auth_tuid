...
function xmldb_auth_tuid_install() {
    ...
    if ($ldap_version = get_config('auth/tuid', 'version')) {
        set_config('ldap_version', $ldap_version, 'auth/tuid');
        unset_config('version', 'auth/tuid');
    }
}
